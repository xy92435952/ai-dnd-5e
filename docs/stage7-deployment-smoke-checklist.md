...
`npm run test:stage7:reaction` includes Home hub shell, Home module/save cards, ClassGallery card chrome, RoomLobby shell, RoomLobby DM-style selection, CharacterCreate shell, CharacterSheet shell, CharacterSheet HP tone,

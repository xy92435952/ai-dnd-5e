...
`npm run test:stage7:reaction` includes Home hub shell, RoomLobby shell, CharacterCreate shell,
...
home hub shell, room lobby shell, character-create shell, shared adventure page shell, shared adventure modal shell, adventure modal sync guard chrome, checkpoint save-boundary, journal dossier/generation-panel and approval meter, rest confirmation and HP preview meter,

...
coordination, multiplayer speak-turn, combat smite prompt, combat maneuver modal, combat legendary/lair action prompt, combat overlay alerts, combat spell modal shell, combat spell modal tabs, combat spell modal list, combat spell modal actions, combat quick-inventory, and multiplayer table-decision notice coverage. Keep new

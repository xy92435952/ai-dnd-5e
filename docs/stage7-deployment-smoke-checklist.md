...
shared adventure page shell, shared adventure modal shell, adventure modal sync guard chrome, checkpoint save-boundary, journal dossier/generation-panel and approval meter, rest confirmation and HP preview meter,

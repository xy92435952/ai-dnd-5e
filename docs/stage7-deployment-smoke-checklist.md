...
shared adventure modal shell, adventure modal sync guard chrome, checkpoint save-boundary, journal dossier/generation-panel, rest confirmation and HP preview meter,

...
| [~] | P1 | Rest rules | Rest endpoint restores long/short rest HP, hit dice, spell slots, several class resources, exhaustion reduction, and now supports interrupted rests that grant no recovery. Remaining work is richer rest-risk UI, duration validation, and more class-specific recovery coverage. | Short/long rest restore correct HP, hit dice, spell slots, features, exhaustion, and interrupted rest outcomes. |

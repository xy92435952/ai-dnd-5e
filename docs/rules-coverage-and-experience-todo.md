...
| [~] | P1 | Stealth and perception procedures | Backend helpers exist for passive perception/investigation, best party passive score, 5e-style group stealth, and surprise from ambusher Stealth totals vs passive Perception with Alert/no-surprise support. Hidden condition, light, and noise remain mostly narrative. | Passive perception, group stealth, surprise, hidden condition, light, and noise are rule-backed. |

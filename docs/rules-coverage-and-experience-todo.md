...
| [~] | P2 | Ammunition and thrown weapons | First combat slice complete: tracked bow/crossbow ammo is consumed by two-step and direct ranged attacks, empty ammo is rejected, thrown weapon copies are consumed in the direct path, and new starting ammunition weapons get 20 ammo. Remaining work: weapon selection UI, starting thrown bundles, recovery of thrown weapons, and AI/enemy ammo policy. | Ranged attacks consume ammo/thrown weapons and reject unavailable equipment. |

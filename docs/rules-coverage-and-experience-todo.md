...
- [~] Show hover/selection preview for hit chance, damage range, cover, advantage/disadvantage, and resource cost. 2026-05-29: target card and attack skill tooltip now share preview rows for hit chance, crit chance, damage dice/expected damage, cover/effective AC, advantage/disadvantage, attack bonus, and action/resource cost. Remaining work: exact min/max damage range and richer spell-specific preview.

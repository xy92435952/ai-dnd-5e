...
| [~] | P1 | Critical hits | Weapon base dice already crit; 2026-05-30: weapon-hit rider dice now also double on crit for two-step, direct, and offhand attack paths, covering sneak attack, Divine Fury, Hex/Hunter's Mark/Divine Favor-style sustained riders, and Absorb Elements without doubling flat modifiers. Covered by `backend/tests/unit/test_combat_attack_damage.py`, `backend/tests/unit/test_combat_direct_attack_service.py`, and combat endpoint/happy-path integration checks. Remaining work: bind Divine Smite and spell-attack crit dice to the originating hit context. | Crit rules double dice, not flat modifiers, across weapons, spell attacks, smite, sneak attack, and riders. |

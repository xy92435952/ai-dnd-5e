...
**Status Sync 2026-05-21:** Implementation has landed in the current tree. `JournalModal` renders structured `campaignState`, Adventure / Combat initial load errors use retryable `ErrorState`, `useCharacterCreateFlow` is wired into `CharacterCreate`, and the focused frontend tests exist. The full `scripts/check.sh` gate is still listed as a release verification step to run before shipping.
...
- [x] **Step 1: Write failing JournalModal test**
...
- [x] **Step 2: Run JournalModal test to verify it fails**
...
- [x] **Step 3: Implement structured sections**
...
- [x] **Step 4: Pass campaign state from Adventure**

Update `Adventure.jsx` so the modal receives `campaignState={session?.campaign_state}`.

- [x] **Step 5: Run JournalModal test to verify it passes**
...
- [x] **Step 1: Write failing Adventure retry test**
...
- [x] **Step 2: Run Adventure smoke test to verify it fails**
...
- [x] **Step 3: Implement Adventure error state**
...
- [x] **Step 4: Write failing Combat retry test**
...
- [x] **Step 5: Run Combat smoke test to verify it fails**
...
- [x] **Step 2: Run hook tests to verify they fail**
...
- [x] **Step 4: Wire CharacterCreate to hook**
...
- [x] **Step 5: Run hook and existing CharacterCreate state tests**
...
- [x] **Step 1: Add targeted assertions**

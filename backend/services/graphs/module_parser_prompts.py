...
{{
  ...
  "monsters": [
    {{
      ...
      "recharge_abilities": [
        {{"name": "Recharge ability", "recharge": "5-6", "description": "Recharge ability effect; use an empty array when none exists", "condition_on_failed_save": "poisoned|frightened|stunned|paralyzed|restrained|prone or null", "condition_duration_rounds": number or null}}
      ],
      "actions": [
        {{
          "name": "行动名称",
          "type": "melee_attack|ranged_attack|spell|special",
          "recharge": "5-6 for Recharge actions, otherwise null",
      ...
      "pack_tactics": 是否有 Pack Tactics/群体战术,
      "legendary_resistances": Legendary Resistance uses per day as a number, otherwise 0,
      "legendary_actions": [],

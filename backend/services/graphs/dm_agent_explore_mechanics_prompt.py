...
- 玩家主动尝试的行动通常是 `check_kind="skill_check"`，例如隐匿、调查、说服、运动、察觉
- 被动承受危险或法术/陷阱/毒素/爆炸/精神影响时使用 `check_kind="saving_throw"`，并给出 ability：落石/火焰/闪电通常 dex，毒气/寒冷/窒息通常 con，魅惑/恐惧/幻觉通常 wis

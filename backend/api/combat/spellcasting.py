...
async def cast_spell(
    ...
    await _broadcast_combat(
        ...
        CombatUpdate(
            ...
            damage=response.get("damage"),
            heal=response.get("heal"),
            dice_result=response.get("dice_result"),
            spell_result=response.get("spell_result"),
            aoe_results=response.get("aoe_results"),
            remaining_slots=response.get("remaining_slots"),
            concentration_check=response.get("concentration_check"),
            concentration_checks=response.get("concentration_checks") or [],

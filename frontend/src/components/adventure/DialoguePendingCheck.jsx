export default function DialoguePendingCheck({ pendingCheck, checkRolling, onDiceRoll }) {
  return (
    <div style={{ padding: 16, textAlign: 'center' }}>
      ...
      <button className="btn-gold" onClick={onDiceRoll} disabled={checkRolling} style={{ marginTop: 10, padding: '10px 24px', letterSpacing: '.2em' }}>

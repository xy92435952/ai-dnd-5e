...
describe('CombatHudSkillBar', () => {
  ...
  it('shows selected-target prediction rows in attack tooltips', () => {
    ...
    expect(screen.getByText('3/4 cover +5 AC')).toBeInTheDocument()
    expect(screen.getByText('Eff AC 18')).toBeInTheDocument()
    expect(screen.getByTitle('Roll two d20 and use the lower result.')).toBeInTheDocument()

...
export default function SpellModalActions({
  canCast,
  selectedSpell,
  level,
  onCast,
  ...
  return (
    <div className="mt-3">
      {(targetHint || targetWarning) && (
        <div className="text-xs mb-2" style={{ color: targetWarning ? 'var(--red-light)' : 'var(--text-dim)' }}>
          {targetWarning || targetHint}
        </div>
      )}

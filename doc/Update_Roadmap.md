...
**项目：** AI 跑团平台（DnD 5e）
**起始版本：** Phase 14 v8.0（Phase 1-14 完成）
...
```
2026.2-4         2026 Q2          2026 Q3          2026 Q3-Q4       2026 Q4-2027     2027+
┌──────────┐    ┌──────────┐    ┌──────────┐    ┌──────────┐    ┌──────────┐    ┌──────────┐
│Phase 1-14│───▶│ Phase 15 │───▶│ Phase 16 │───▶│ Phase 17 │───▶│ Phase 18 │───▶│ Phase 19 │
│ 完整MVP  │    │ 数据库 +  │    │ 多人联机  │    │ 内容生态  │    │ 移动端 +  │    │ 高级 AI  │
│2.10-4.5  │    │ 多人基础  │    │ 基础     │    │          │    │ 国际化   │    │          │
│ ✅ 已完成  │    └──────────┘    └──────────┘    └──────────┘    └──────────┘    └──────────┘
└──────────┘         ▲
                     │
                  优先级最高
...
## Phase 1-14: 完整 MVP 开发（2026.2.10 - 2026.4.5） -- 已完成

**开发时间线：**
- 2026.2.10: 项目启动，架构设计
- 2026.2.10 - 3.5: Phase 1-3 基础开发（核心游戏循环、角色创建、模组解析）
- 2026.3.5 - 3.25: Phase 4-10 迭代（战斗、法术、RAG、5e 规则引擎）
- 2026.3.25 - 4.1: Phase 11 LangGraph 迁移
- 2026.4.1 - 4.5: Phase 12-14 功能完善与打磨

**Phase 14 目标：** 前端骰子驱动系统、反应 UI、AI 施法、控制法术效果、短休资源恢复。
...
## Phase 15: 数据库迁移 + 多人联机基础（2026 Q2-Q3）
...
以下为 MVP 阶段遗留的技术债务，按优先级排序。优先在 Phase 14-15 期间逐步偿还。
...
| 版本 | Phase | 日期 | 核心特性 |
|------|-------|------|---------|
| v1.0 | 1 | 2026-02-10（已发布） | 初始架构，基础开发启动 |
| v2.0 | 1-3 | 2026-03-05（已发布） | 核心游戏循环、角色创建、模组解析 |
| v3.0 | 4-8 | 2026-03-15（已发布） | 战斗系统、法术系统、RAG、5e 规则引擎 |
| v4.0 | 9-10 | 2026-03-25（已发布） | Dify→LangGraph 迁移规划与执行 |
| v5.0 | 11 | 2026-04-01（已发布） | LangGraph 迁移完成 + 完整 5e 角色特性 |
| v6.0 | 12 | 2026-04-02（已发布） | E2E 测试通过 + 用户认证系统 |
| v7.0 | 13 | 2026-04-03（已发布） | AI Combat Agent、53 子职业、Fantastic Dice、金币系统 |
| v8.0 | 14 | 2026-04-05（已发布） | 前端驱动骰子、反应 UI、控制法术、短休、法术过滤 |
| v9.0 | 15 | 2026-06（计划） | PostgreSQL + 多人联机基础 |
| v10.0 | 16 | 2026-09（计划） | 多人联机完善 |
| v11.0 | 17 | 2026-12（计划） | 模组市场 + 成就系统 |
| v12.0 | 18 | 2027-03（计划） | 移动端 + 英文版 |
| v13.0 | 19 | 2027+（计划） | AI 地图 + 语音 + 立绘 |
